...
static void hevc_d_h265_setup(struct hevc_d_ctx *ctx, struct hevc_d_run *run)
{
	struct hevc_d_dev *const dev = ctx->dev;
...
static void hevc_d_h265_trigger(struct hevc_d_ctx *ctx)
{
	struct hevc_d_dev *const dev = ctx->dev;
...
const struct hevc_d_dec_ops hevc_d_dec_ops_h265 = {
	.setup = hevc_d_h265_setup,
	.start = hevc_d_h265_start,
