...
struct hevc_d_dec_ops {
	void (*setup)(struct hevc_d_ctx *ctx, struct hevc_d_run *run);
	int (*start)(struct hevc_d_ctx *ctx);
	void (*stop)(struct hevc_d_ctx *ctx);
	void (*trigger)(struct hevc_d_ctx *ctx);
};
